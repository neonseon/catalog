...
def showApiCategories():
    ...
    if 'username' not in login_session:
        return render_template('public-api-categories.html', api_categories=api_categories)
    else:
        return render_template('api-categories.html', api_categories=api_categories)
...
def showApiCategory(api_category_name):
    ...
    if 'username' not in login_session:
        ...
        return render_template('api-category.html', apis=apis, api_category=api_category, category_id=api_category.id)
